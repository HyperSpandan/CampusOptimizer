      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col gap-8 mb-12">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
            <div className="max-w-2xl">
              ...
              >
                <Badge variant="outline" className="rounded-full bg-primary/10 text-primary border-primary/20 font-black px-4 py-1.5 text-[10px] uppercase tracking-[0.2em]">
                  Live Inventory
                </Badge>
                <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-border">
                  <div className="w-1.5 h-1.5 rounded-full bg-primary animate-pulse" />
                  <span className="text-[10px] text-muted-foreground font-black uppercase tracking-widest">System Online</span>
                </div>
              </motion.div>
              <motion.h1 
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                className="text-6xl md:text-7xl font-black tracking-tighter leading-[0.85] uppercase mb-6"
              >
                CAMPUS <br />
              ...
              <motion.p 
                ...
                className="text-muted-foreground text-lg font-medium max-w-lg"
              >
              ...
              <div className="relative group">
                ...
                <div className="relative">
                  ...
                  <Input 
                    ...
                    className="pl-14 w-full h-16 rounded-[1.5rem] glass border-border focus:border-primary/50 transition-all font-bold text-lg"
                    value={searchQuery}
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {stats.map((stat, i) => (
              ...
              >
                <TiltCard className="p-6 flex items-center gap-5">
                  <div className={cn("w-14 h-14 rounded-2xl flex items-center justify-center transition-all group-hover:scale-110 bg-white/5", stat.color)}>
        ...
        <Tabs defaultValue="infrastructure" className="w-full flex flex-col items-center" onValueChange={setActiveTab}>
          <div className="w-full flex flex-col items-center gap-8 mb-16">
            <TabsList className="h-16 p-1.5 glass rounded-2xl border border-border flex items-center justify-center">
              <TabsTrigger 
                value="infrastructure" 
                className="rounded-xl px-10 font-black text-[10px] uppercase tracking-[0.2em] data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:neon-glow transition-all h-full flex items-center"
              >
            ...
            <div className="flex items-center gap-3">
              <div className="px-6 py-2 rounded-full glass border border-border flex items-center gap-3">
        ...
        >
          <div className="absolute -inset-1 bg-gradient-to-r from-primary to-blue-500 rounded-[3rem] blur opacity-20 group-hover:opacity-40 transition duration-1000" />
          <div className="relative glass-dark p-10 md:p-12 rounded-[3rem] border border-primary/20 flex flex-col lg:flex-row items-center justify-between gap-10 overflow-hidden">
            <div className="absolute top-0 right-0 w-96 h-96 bg-primary/10 rounded-full blur-[100px] -mr-48 -mt-48" />
            
            <div className="flex flex-col md:flex-row items-center gap-8 relative z-10 text-center md:text-left">
              <div className="w-24 h-24 bg-primary/10 rounded-[2rem] flex items-center justify-center neon-glow animate-float shrink-0">
                <Sparkles className="w-12 h-12 text-primary" />
              </div>
              <div>
                <Badge className="bg-primary/20 text-primary border-primary/30 mb-4 rounded-full px-4 py-1 font-black text-[10px] uppercase tracking-[0.2em]">
                  AI Optimization
                </Badge>
                <h2 className="text-3xl md:text-4xl font-black tracking-tighter mb-4 uppercase leading-none">SMART BUNDLE <br className="hidden md:block" /> SUGGESTION</h2>
            ...
            <Button className="bg-primary text-primary-foreground rounded-2xl px-12 h-16 text-sm font-black hover:neon-glow transition-all relative z-10 w-full lg:w-auto uppercase tracking-[0.2em] shadow-2xl shadow-primary/20">
              BOOK BUNDLE
            </Button>
          </div>
        </motion.div>
